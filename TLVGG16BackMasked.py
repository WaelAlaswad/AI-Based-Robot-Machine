...
train = ImageDataGenerator(zoom_range=0.2, rotation_range=20) # shear_range : Prespective angle
train_batches = train.flow_from_directory(directory= "/content/drive/MyDrive/AiandML/Camera2/Training/Back",target_size=(224,224), classes= ["Bad","Good"],batch_size=50)

valid = ImageDataGenerator() # shear_range : Prespective angle
valid_batches = train.flow_from_directory(directory= "/content/drive/MyDrive/AiandML/Camera2/Training/Back",target_size=(224,224), classes= ["Bad","Good"],batch_size=50)
...
# Model saving
transferred_model.save("/content/drive/MyDrive/AiandML/TLVGG16BackMask.h5")